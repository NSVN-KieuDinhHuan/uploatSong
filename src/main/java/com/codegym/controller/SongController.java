...
public class SongController {
    ...
    public ModelAndView showCreateSong() {
        ...
        modelAndView.addObject("song", new SongForm());//Gửi 1 đối tượng product rỗng sang file view để tạo mới
        return modelAndView;
    }
    ...
    @PostMapping("/edit/{id}")
    public ModelAndView editProduct(@PathVariable Integer id, @ModelAttribute Song song) {
        songService.updateById(id, song);
        return new ModelAndView("redirect:/song/list");
    }
